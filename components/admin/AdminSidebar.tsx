...
export function AdminSidebar({ activeTab, setActiveTab }: AdminSidebarProps) {
  ...
  return (
    <aside className="w-64 bg-slate-900 border-r border-slate-800 text-slate-300 flex flex-col h-screen overflow-y-auto">
      {/* Brand */}
      <div className="p-6 border-b border-slate-800 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg font-bold text-white font-display leading-tight">ApexQuant</h1>
          <p className="text-[10px] uppercase tracking-widest text-blue-400 font-bold">Admin Portal</p>
        </div>
      </div>
